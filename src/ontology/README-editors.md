These notes are for the EDITORS of emote
...
Make sure you have an ID range in the [idranges file](emote-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [emote-edit.owl](emote-edit.owl)

** DO NOT EDIT emote.obo OR emote.owl in the top level directory **

[../../emote.owl](../../emote.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/uflcod/emotion-experience-ontology) for details.
 ...
 * [emote-idranges.owl](emote-idranges.owl)
...
This generates derived files such as emote.owl and emote.obo and places
 ...
 * https://github.com/uflcod/emotion-experience-ontology/releases
 * https://github.com/uflcod/emotion-experience-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived emote.owl (`data-version` in
emote.obo). This will be today's date.
 ...
 * https://w3id.org/emototion-experience-ontology/emote.owl <-- current ontology PURL
 * https://w3id.org/emototion-experience-ontology/emote/releases/YYYY-MM-DD.owl <-- change to the release you just made